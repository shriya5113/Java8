...
//    javaeigth.Singleton is a design pattern that restricts the instantiation of a
//    class to one single instance and provides a global point of access to that instance.
//    The javaeigth.Singleton pattern ensures that only one instance of a class is created, and that instance is
...
//    A more modern and elegant way to implement the javaeigth.Singleton pattern is using the Bill Pugh javaeigth.Singleton Design,
